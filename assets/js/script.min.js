...
const Prefix = "PREFIX_TEXT" // Prefix ex: PREFIX_TEXTping
const Status = "STATUS_TEXT" // Game text
const VisibleStatus = "VISIBLE_STATUS_TEXT" // online,dnd,offline,idle
...
document.getElementById("Generate").onclick = function(e) {    
    console.log("wat")
    StarterCode = StarterCode.replace(/PREFIX_TEXT/, document.getElementById('Prefix').value)
    
    StarterCode = StarterCode.replace(/STATUS_TEXT/, document.getElementById('Status').value)
    
    const VisibleStatusValue = document.getElementById('VisibleStatus').options[document.getElementById('VisibleStatus').selectedIndex].value 
   
    if (VisibleStatusValue == 12) {
       StarterCode = StarterCode.replace(/VISIBLE_STATUS_TEXT/, "online") 
    } else if (VisibleStatusValue == 13) {
        StarterCode = StarterCode.replace(/VISIBLE_STATUS_TEXT/, "dnd") 
    } else if (VisibleStatusValue == 14) {
        StarterCode = StarterCode.replace(/VISIBLE_STATUS_TEXT/, "offline") 
    }
    document.getElementById('Code').innerHTML = StarterCode
}
